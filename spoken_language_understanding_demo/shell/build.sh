...
CMAKE_COMMAND_ARGS="-DCMAKE_VERBOSE_MAKEFILE=ON -DUSE_FULL_API=${USE_FULL_API} -DTARGET_OS=${TARGET_OS} -DTARGET_ABI=${TARGET_ABI} -DPADDLE_LITE_DIR=$(readlinkf ../../libs/PaddleLite) -DFAST_TOKENIZER_DIR=$(readlinkf ../../libs/FastTokenizer)"
