...
## Spoken language understanding demo based on ERNIE 3.0 tiny etc.
```
cd spoken_language_understanding_demo/shell
```
### CPU
- Arm CPU (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a cpu UQG0220A15000356
  ```
- Arm CPU (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 cpu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 cpu 192.168.100.30 22 khadas khadas
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux armhf cpu 192.168.100.13 22 root rockchip
  ```
- x86 CPU (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 cpu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 cpu localhost 9031 root root
  ```
### OpenCL
-  Arm CPU + Mali/Adreno GPU (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a opencl UQG0220A15000356
  ```
- Arm CPU + Mali GPU (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 opencl
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 opencl 192.168.100.30 22 khadas khadas
  ```
- x86 CPU + Intel/Nvidia GPU (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 opencl
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 opencl localhost 9031 root root
  ```
### Huawei Kirin NPU
- Huawei P40pro 5G (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a huawei_kirin_npu UQG0220A15000356
  ```
### MediaTek APU
- MediaTek MT8618 Tablet (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android armeabi-v7a mediatek_apu 0123456789ABCDEF
  ```
### Imagination NNA
- ROC1 (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 imagination_nna
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 imagination_nna 192.168.100.10 22 img imgroc1
  ```
### Huawei Ascend NPU
- x86 CPU + Huawei Atlas 300C(3010) (Ubuntu)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 huawei_ascend_npu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 huawei_ascend_npu localhost 9031 root root
  ```
- Arm CPU + Huawei Atlas 300C(3000) (CentOS)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 huawei_ascend_npu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 huawei_ascend_npu localhost 9031 root root
  ```
### Verisilicon TIM-VX (Rockchip NPU and Amlogic NPU)
- Khadas VIM3L (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android armeabi-v7a verisilicon_timvx c8631471d5cd
  ```
- Khadas VIM3 (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx 192.168.100.30 22 khadas khadas
  ```
- RK1808EVB (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx a133d8abb26137b2
  ```
- Toybirck TB-RK1808S0 (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 verisilicon_timvx 192.168.180.8 22 toybrick toybrick
  ```
- RV1109 (Linux)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux armhf verisilicon_timvx
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux armhf verisilicon_timvx 192.168.100.13 22 root rockchip
  ```
### Kunlunxin XPU with XDNN
- x86 CPU + Kunlunxin K100 (Ubuntu)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 xpu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 xpu localhost 9031 root root
  ```
- Arm CPU + Kunlunxin K200 (KylinOS)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 xpu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 xpu localhost 9031 root root
  ```
### Kunlunxin XPU with XTCL
- x86 CPU + Kunlunxin K100 (Ubuntu)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 kunlunxin_xtcl
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 kunlunxin_xtcl localhost 9031 root root
  ```
- Arm CPU + Kunlunxin K200 (KylinOS)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 kunlunxin_xtcl
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux arm64 kunlunxin_xtcl localhost 9031 root root
  ```
### Cambricon MLU
- x86 CPU + Cambricon MLU 370 (Ubuntu)
  ```
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 cambricon_mlu
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 cambricon_mlu localhost 9031 root root
  ```
### Android NNAPI
- Huawei P40pro 5G (Android)
  ```
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a android_nnapi UQG0220A15000356
  ```
### Qualcomm QNN
- x86 CPU (QNN Simulator, Ubuntu)
  ```
  ...
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 qualcomm_qnn
  ./run.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 qualcomm_qnn "QUALCOMM_QNN_ENABLE_FP16=true"

  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 qualcomm_qnn localhost 9031 root root
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test linux amd64 qualcomm_qnn localhost 9031 root root "QUALCOMM_QNN_ENABLE_FP16=true"
  ```
- Qualcomm 8295P EVK (Android)
  ```
  adb -s 858e5789 root

  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a qualcomm_qnn 858e5789
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a qualcomm_qnn 858e5789 "QUALCOMM_QNN_ENABLE_FP16=true"
  ```
- Qualcomm 8295P EVK (QNX)
  ```
  export FILE_TRANSFER_COMMAND=lftp
  ...
  rm -rf ../assets/models/cache
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a qualcomm_qnn 858e5789 null cache
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test qnx arm64 qualcomm_qnn 192.168.1.1 22 root root null cache

  rm -rf ../assets/models/cache
  ./run_with_adb.sh ernie_3.0_tiny_fp32 default.txt test android arm64-v8a qualcomm_qnn 858e5789 "QUALCOMM_QNN_ENABLE_FP16=true" cache
  ./run_with_ssh.sh ernie_3.0_tiny_fp32 default.txt test qnx arm64 qualcomm_qnn 192.168.1.1 22 root root "QUALCOMM_QNN_ENABLE_FP16=true" cache
  ```
